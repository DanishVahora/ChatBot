...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#121212]">
      ...
      {/* Add this floating action button before ChatBot */}
      <motion.button
        initial={{ opacity: 0, scale: 0.5 }}
        animate={{ opacity: 1, scale: 1 }}
        whileHover={{ scale: 1.05 }}
        className="fixed bottom-28 right-6 bg-[#F79B72] text-white px-6 py-3 rounded-full shadow-lg z-40 flex items-center space-x-2"
        onClick={() => window.open('tel:1-800-AUTO-VIBE')}
      >
